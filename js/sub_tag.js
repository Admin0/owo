var tag = [
  ...
  "오늘도_쌓인_업무,_내일로_미루자", "오늘의_할_일:_생존", "오늘도_야근의_늪에_빠졌다", "화장실이_유일한_안식처", "금요일_오후_5시를_기다리며",
  "퇴근_후에도_일은_끝나지_않아", "이번달도_월급루팡", "오늘도_살아남았다_출근한_나에게_박수", 
  "오늘도_자리에_물건을_뿌리고_나갔다", "칼퇴는_내가_제일_잘해", "최고의_아이디어는_퇴근길에_떠오른다", "자리에_앉으면_곧_졸림_모드_ON", 
  "월급이_나의_무기", "초조한_눈치보기_대회", "점심시간_행복의_시간", "카페인은_나의_에너지_드링크", "회의는_나의_수면제",
  "잠깐만...쉴까?", "누군가에게_물어봐도_모르는_업무", "아무도_할줄_모르는데_왜_내가_담당자야?", 
  "퇴근_후에도_생존은_계속된다", "빈_회의실은_나의_휴식처", "회의는_언제_끝날까?",
  "퇴근_후에도_일은_계속된다", "매일매일_똑같은_업무_똑같은_일상", "금요일_오전_마음만은_퇴근_모드", "출근길에_증말_어지러워",
  "카페인_중독자의_일상", "내일은_쉴까", "오늘도_나는_일하는_중", "금요일에는_정말_일_안_하고_싶다", "여긴어디_나는누구?",
];
